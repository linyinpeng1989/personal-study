...
import com.netty.rpc.protocol.ProtoStuffSerializableUtil;
...
public class JsonTest {
    public static void main(String[] args){
        ...
        byte[] datas2 = ProtoStuffSerializableUtil.serialize(response);
    ...
    private static void TestJsonSerialize(){
        ...
        byte[] datas2 = ProtoStuffSerializableUtil.serialize(request);
        System.out.println("Protobuf byte length: " + datas2.length);
