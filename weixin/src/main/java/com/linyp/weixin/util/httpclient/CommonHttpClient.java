...
public class CommonHttpClient {
	 ...
	 * 初始化
	 */
	public CommonHttpClient(CloseableHttpClient client) {
		this.client = client;
	}
	 ...
	 * @return
	 */
	public String doPost(String url, Map<String, Object> params, String encoding) {
	 ...
	 * @return
	 */
	public String doPost(String url, Map<String, Object> params, Map<String, Object> headers, String encoding) {
		String result = "";
		try {
			...
			if (null != params && params.size() > 0) {
				...
				while (it.hasNext()) {
					String key = it.next();
					cons.add(new BasicNameValuePair(key, (String) params.get(key)));
				}
